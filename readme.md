...
众所周知，在维咔点击链接下载学习资料的时候，会遇到非常烦人的广告，点击了，不仅没能打开正确的链接，还总是跳出新的广告，并且是个不断循环的过程，压根没有下载的机会，只能当个无情的刷广告机器（官方定性为"误触"）。

为此，本脚本提供了一种绕过广告，直接在当前页面获取资源链接的方式，并提供复制功能（在原下载链接旁边可以看到）。
